...
public class ScienceAdapter extends RecyclerView.Adapter implements QuestionTypeListener, DragDropListener {
    ...
    public static final int KEYWORDS_QUESTION = 11;
...
*/
            ...
            case KEYWORDS_QUESTION:
                LayoutInflater keywordsQuestion = LayoutInflater.from(viewGroup.getContext());
                v = keywordsQuestion.inflate(R.layout.layout_fill_in_the_blanks_wo_option_row, viewGroup, false);
                return new FillInTheBlanksWithoutOptionsViewHolder(v, context, this);
...
*/
            ...
            case AUDIO:
                ...
                break;
            case KEYWORDS_QUESTION:
                FillInTheBlanksWithoutOptionsViewHolder keywordsQuestion = (FillInTheBlanksWithoutOptionsViewHolder) myViewHolder;
                keywordsQuestion.setFillInTheBlanksQuestion(scienceQuestion, myViewHolder.getAdapterPosition());
                //      questionTypeListener.setType(FILL_IN_THE_BLANK, answer);
