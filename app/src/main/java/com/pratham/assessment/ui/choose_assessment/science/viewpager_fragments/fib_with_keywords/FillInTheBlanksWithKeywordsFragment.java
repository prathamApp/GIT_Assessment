...
public class FillInTheBlanksWithKeywordsFragment extends Fragment
        implements FIB_With_keywords_Contract.FIB_WithoutOption_View,
        STT_Result {

    @Bean(FIB_With_keywords_Presenter.class)
    FIB_With_keywords_Contract.FIB_WithoutOptionPresenter presenter;
    ...
    public void init() {
        ...
        presenter.setView(FillInTheBlanksWithKeywordsFragment.this);
        if (question != null)
    ...
    //TODO MAYBE UTILITY
    public static FillInTheBlanksWithKeywordsFragment newInstance(int pos, ScienceQuestion scienceQuestion) {
        FillInTheBlanksWithKeywordsFragment_ fragment = new FillInTheBlanksWithKeywordsFragment_();
