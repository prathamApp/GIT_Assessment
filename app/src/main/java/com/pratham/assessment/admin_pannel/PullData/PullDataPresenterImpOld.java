...
public class PullDataPresenterImpOld implements PullDataContract.PullDataPresenter {
    Context context;
    ...
    public PullDataPresenterImpOld(Context context, PullDataContract.PullDataView pullDataView) {
